...
namespace SpindlesSoftTestCases.PeoplePractice_Tests
{
    class CustomerTestCases
    {
        ...
        //getCustomerimage
        [Test]
        [TestCase("3222222223", true)]
        [TestCase("8971100727", false)]
        public void GetCustomerImage_Test(string mobileNo, bool success)
        {
            Image image = PeoplePracticeBuilder.GetCustomerImage(mobileNo);
        ...
        [Test]
        [TestCase("Customer1", "2111111112", "3222222223", "#no Address", "n@s.com"),
        TestCase("Customer2", "2111111113", "3222222224", "", "m@s.com"),
        TestCase("Customer3", "2111111114", "3222222225", "", "")]
        public void SaveCustomerInfo_Test(string name, string mobNo, string phoneNo, string address = "", string email = "")
        {
            ...
            bool success = PeoplePracticeSaver.SaveCustomerInfo(cust);
            Assert.AreEqual(success, true);
        }

        [Test]
        [TestCase("C:\\Users\\NSuhanShetty\\Desktop\\icon\\AddReferral.png", "3222222223")]
        [TestCase("C:\\Users\\NSuhanShetty\\Desktop\\icon\\User.png", "3222222223")]
        public void SaveCustomerImage_Test(string path, string mobNo)
        {
            //byte[] bytes = System.IO.File.ReadAllBytes(path);
            //System.IO.MemoryStream ms = new System.IO.MemoryStream(bytes);
            Image image = Image.FromFile(path);
            bool success = PeoplePracticeSaver.SaveCustomerImage(image, mobNo);
            Assert.AreEqual(success, true);
        }
        #endregion Customer
    }
